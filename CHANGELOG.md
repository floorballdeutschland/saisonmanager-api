...
- **Erst-/Zweitlizenz wurde über Verbandsgrenzen hinweg verlangt**: Bei der Genehmigung einer Großfeld-Lizenz im Erwachsenenbereich fragte der Saisonmanager nach einer Erst-/Zweitlizenz-Zuordnung, sobald die Person eine weitere Großfeld-Lizenz desselben Wettbewerbs hielt, auch wenn diese in einem anderen Spielbetrieb lag. Erst- und Zweitlizenz gibt es aber nur innerhalb eines Spielbetriebs. Zwischen einer Lizenz bei Floorball Deutschland und einer im Landesverband besteht dieses Verhältnis nicht, dort gilt allein die Unterscheidung Haupt-/Zusatzlizenz nach Ligahöhe. Der Spielbetrieb gehört jetzt zur Wettbewerbsdefinition. Damit entfällt die unnötige Rückfrage, und die automatische Gegenbuchung stuft keine Lizenz eines fremden Spielbetriebs mehr zur Zweitlizenz herab. Jeder Spielbetrieb hat außerdem sein eigenes Tausch-Budget pro Saison. Bereits gespeicherte Zuordnungen bleiben unverändert; wo sie über Verbandsgrenzen hinweg entstanden sind, müssen sie von Hand bereinigt werden.
