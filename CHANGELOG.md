...
- **Spielplan-Import erneut hochladbar (Überschreiben)**: Der Import einer Spielplan-Vorlage war bisher nur einmalig möglich – sobald eine Liga Spiele/Spieltage hatte, wurde jeder weitere Import mit „Liga hat bereits Spiele und/oder Spieltage" abgewiesen. Jetzt lässt sich eine Vorlage erneut hochladen und ersetzt den bestehenden Spielplan vollständig, **solange noch kein Spiel begonnen bzw. gespielt wurde**. Dadurch können schon vor dem ersten Spieltag erste – auch lückenhafte – Vorlagen eingespielt und später verfeinert werden. Sobald ein Spiel begonnen/gespielt ist (gestartet, beendet, Spielbericht angelegt oder abgeschlossen), wird der gesamte Import blockiert. Beim Überschreiben werden bestehende Spieltage/Spiele inkl. daran hängender Schiedsrichter-Ansetzungen, Sekretär-Links und Bestätigungen entfernt.
