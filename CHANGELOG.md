...
- **Gelöschte Ligen verschwinden auch aus den Pokalliga-Angaben**: Trägt eine Mannschaft eine zusätzliche Liga, blieb deren Eintrag beim Löschen der Liga stehen. Ursache war der Wartungslauf für leere Ligen: Er prüfte vor dem Löschen, ob eine Liga von anderen Ligen oder von Qualifikationen gebraucht wird, aber nicht, ob sie bei einer fremden Mannschaft als zusätzliche Liga hinterlegt ist. Eine Liga, auf die nur so verwiesen wurde, hatte selbst keine Mannschaften, galt damit als leer und wurde gelöscht. Dieser Weg ist zu, und die 22 betroffenen Mannschaften räumt ein neuer Wartungslauf auf. Anders als bei der Liga der Mannschaft kann die Datenbank hier nicht selbst schützen, deshalb sucht die Datenprüfung solche Reste künftig mit.
