...
- **Admin: Teams löschen**: Neue `DELETE admin/teams/:id`-Route für Admin/SBK (analog zur bisherigen `update_team`-Berechtigung). Löschen wird mit erklärender 422-Meldung abgelehnt, solange dem Team noch Spieler/Lizenzen, Spiele/Ergebnisse oder sonstige verknüpfte Einträge (z.B. Spieltag-Bestätigungen) zugeordnet sind.
