...
- **Partnerlogos für die Livestream-Overlays**: Vereine und Verband können Partnerlogos hinterlegen, die im Stream in einer eigenen Fläche eingeblendet werden. Es gibt zwei Ebenen, die sich nicht ausschließen: Der Verband pflegt die Partner einer Liga, der Verein die seines Vereins. Auf Sendung laufen beide Sätze reihum durch dieselbe Fläche. Zuständig ist damit jeweils, wer auch die Rechte hält. Je Ebene sind bis zu acht Logos möglich; erlaubt sind PNG, JPG und WebP bis 1 MB, und wie bei allen Logo-Feldern gilt die Empfehlung, freigestellte Dateien zu verwenden — auf dunklem Grund fällt ein weißer Kasten sofort auf.
