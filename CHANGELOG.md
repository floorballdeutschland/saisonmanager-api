...
- **„Meine Spieler\*innen“ öffnet sich auch mit SBK-Rolle**: Wer neben der Vereinsrolle auch die Spielbetriebsrolle eines Landesverbands hat, bekam auf der Seite nur „Berechtigungsfehler“ und wurde auf die Startseite geworfen, statt die eigene Vereinsliste zu sehen. Die Seite lädt die Vereine des Spielbetriebs und fragt für jeden die Spielerliste ab; erlaubt war die Abfrage aber nur für Vereine, deren Heim-Spielbetrieb der eigene ist. Gastvereine aus anderen Landesverbänden standen damit in der eigenen Liste, wurden beim Laden aber abgewiesen, und weil alle Vereine gleichzeitig geladen werden, riss ein einziger davon die ganze Seite mit. Die Abfrage erlaubt nun dieselben Vereine, die die Liste enthält, also auch Gastvereine des eigenen Spielbetriebs. Vereine ohne jeden Bezug zum eigenen Spielbetrieb bleiben gesperrt.
