...
- **Vereine lassen sich wieder anlegen**: Seit dem Umbau der Vereinsansicht im Mai bot das Formular kein Feld für den Spielbetrieb mehr und schickte beim Anlegen eine 0 mit. Die Anwendung antwortete darauf mit „Nicht gefunden." — einer Meldung, die nach einem fehlenden Verein klingt und nicht nach dem eigentlichen Problem. Über die Oberfläche war seitdem keine Vereinsanlage möglich. Beim Anlegen ist der Spielbetrieb jetzt wieder auswählbar (nur die, in denen man Vereine anlegen darf); beim Bearbeiten bleibt er unverändert, damit er sich nicht versehentlich ändert. Fehlt er oder ist er unbekannt, nennt die Meldung jetzt den Grund.
- **Neu angelegte Vereine erscheinen in der Vereinsverwaltung**: Der Spielbetrieb wurde beim Anlegen als Text statt als Zahl gespeichert. Alle Abfragen suchen nach einer Zahl, weshalb ein frisch angelegter Verein in keiner Vereinsliste auftauchte und auch nicht bearbeitbar war.
