...
- **Fehlerüberwachung meldet keine leeren Spielereignisse mehr**: Enthält der Spielbericht eine Ereigniszeile ohne Spielernummer, prüft das System, ob dort ein Schütze fehlt, und meldet das an die Fehlerüberwachung. Diese Meldung ging bisher auch für Zeilen raus, die überhaupt kein Tor und keine Strafe behaupten, also weder Stand noch Straf- oder Torkennzeichen tragen. In solchen Zeilen fehlt nichts, es gibt nichts zu zählen; gemeldet wurde sie trotzdem bei jedem Aufruf der Spielseite und verdeckte damit die echten Fälle. Tore und Strafen ohne Schützen werden unverändert gemeldet. Für die Anzeige ändert sich nichts.
