...
- **Team-Zuweisung ging beim Anlegen eines Teammanagers verloren**: Wurde ein Teammanager-Konto durch einen Admin oder eine Spielbetriebskommission angelegt und dabei in der Maske ein Team angehakt, kam das Konto trotzdem ohne Team-Zuweisung in der Datenbank an. Die Auswahl wurde beim Speichern kommentarlos verworfen, die Willkommensmail ging raus, und beim ersten Anmelden stand dann „Keine Teams in der aktuellen Saison", obwohl das Team längst angemeldet war. Betroffen war ausschließlich dieser Weg; legte ein Vereinsmanager das Konto an, wurde die Zuweisung korrekt übernommen, und eine nachträglich über „Teams speichern" gesetzte Zuweisung war ebenfalls nie betroffen. Zusätzlich wird eine Team-Auswahl jetzt nicht mehr stillschweigend fallengelassen, wenn sie gar nicht zuweisbar ist (Mannschaft einer vergangenen Saison oder Verein außerhalb des eigenen Zuständigkeitsbereichs), sondern mit einer Meldung abgelehnt, die die betroffenen Teams nennt. Eine Zuweisung auf eine Mannschaft der Vorsaison hätte dasselbe Ergebnis gehabt wie keine Zuweisung, nämlich ein Konto, das sich nicht anmelden kann.
- **Speichern der Benutzermaske löschte die Team-Zuweisung**: Wurde ein Teammanager bearbeitet und danach das allgemeine „Speichern" der Maske benutzt, verlor das Konto seine Team-Zuweisung wieder. Grund war das Zusammenspiel zweier Dinge: Die Maske sendet die Vereinszuordnung immer mit, und die Vereinszuordnung leerte die Team-Zuweisung grundsätzlich, weil ein Vereinswechsel bestehende Zuweisungen tatsächlich hinfällig macht. Der Fall „Verein unverändert" war dabei nicht ausgenommen. Geleert wird jetzt nur noch bei einem echten Vereinswechsel. Werden Verein und Teams in einem Zug geändert, gewinnt die mitgesendete Team-Auswahl.
- **Irreführende Meldung bei fehlender Team-Zuweisung**: Ein Teammanager ohne jede Team-Zuweisung bekam beim Anmelden „Keine Teams in der aktuellen Saison" zu sehen. Das legte einen Saisonwechsel als Ursache nahe, obwohl am Konto einfach noch nie ein Team gesetzt worden war, und schickte die Fehlersuche in die falsche Richtung. Ist keine Zuweisung vorhanden, steht dort jetzt, dass dem Konto kein Team zugewiesen ist und der Vereinsmanager weiterhilft. Der bisherige Text bleibt für den Fall, dass Zuweisungen vorhanden sind, aber alle zu Mannschaften vergangener Saisons gehören.
