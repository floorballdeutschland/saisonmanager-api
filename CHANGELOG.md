...
- **Kursergebnisse aus den erweiterten LV-Meldelisten lassen sich wieder importieren**: Die aktuelle Meldevorlage der Landesverbände enthält fünf zusätzliche Arbeitsspalten (Kommentar, Meldedatum und drei Prüfvermerke) und bricht die Überschriften von „Kurs 1 Datum" und „Kurs 1 Punkte" über zwei Zeilen um. Beim Hochladen wies das System eine solche Datei vollständig ab, mit einer technischen Meldung über unerlaubte Zeilenumbrüche. Ursache waren gemischte Zeilenenden, wie Excel sie exportiert. Diese Dateien werden jetzt gelesen. Zusätzlich ordnet der Import die Spalten nun über ihre Überschriften zu und nicht mehr über ihre Position: Die Spalte „Kommentar LV" steht in der Vorlage vor „Ausbilder" und hätte alles ab dort um eine Stelle verschoben, sodass der Name des Ausbilders stillschweigend verloren gegangen wäre. Ältere Vorlagen mit mehrfach gleich benannten Spalten werden weiterhin wie bisher nach Position gelesen. Fehlt eine Pflichtspalte (Lizenznummer, Name, Vorname oder Geburtsdatum), nennt die Fehlermeldung sie beim Namen, statt die Datei mit falscher Zuordnung zu übernehmen. Die zusätzlichen Arbeitsspalten der Landesverbände werden weiterhin nicht ausgewertet.
