...
class RefereeFeedback < ApplicationRecord
  ...
  belongs_to :game
  belongs_to :team
  belongs_to :referee_1, class_name: 'Referee', optional: true
  belongs_to :referee_2, class_name: 'Referee', optional: true
  ...
  scope :for_referee, lambda { |referee_id|
    where('referee_1_id = :id OR referee_2_id = :id', id: referee_id)
  }
