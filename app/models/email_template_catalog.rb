...
module EmailTemplateCatalog # rubocop:disable Metrics/ModuleLength -- reine Daten-/Katalogdatei
  ENTRIES = {
    'UserMailer#reset_password' => {
      ...
      description: 'Link zum Zurücksetzen des Passworts (enthält den Benutzernamen und den Hinweis, dass der Login über den Benutzernamen läuft und nicht über die E-Mail-Adresse).',
    ...
    'UserMailer#forgot_username' => {
      ...
      default_reply_to: nil,
      placeholders: [
        { key: 'user_names', description: 'Alle Benutzernamen der Adresse, mit Komma getrennt' },
        { key: 'count', description: 'Anzahl der gefundenen Benutzerkonten' },
        { key: 'link', description: 'Link zur Anmeldeseite' }
      ]
    },
    ...
    'PlayerMailer#guardian_privacy_info' => {
      mailer_class: 'PlayerMailer',
      action_name: 'guardian_privacy_info',
      ...
      default_from: nil,
      # Kein fester Wert: Die Antwortadresse setzt der Mailer zur Laufzeit auf die
      # SBK des Spielbetriebs der Liga.
      default_reply_to: nil,
      placeholders: [
        { key: 'player_name', description: 'Vor- und Nachname der minderjährigen Person' },
