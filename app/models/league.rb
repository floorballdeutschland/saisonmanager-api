    ...
    league_teams.each do |team|
      ...
      team_licenses[team.id].each do |player|
        ...
        player_item[:other_licenses] = player.licenses.filter_map do |l|
          ...
          # aktuell durch: Lizenzen von 2012 landeten in other_licenses und
          # brachten die Genehmigungskarte dazu, eine Erst-/Zweitlizenz-Zuordnung
          # zu verlangen, die Player#gf_competition_licenses (strikter
          # Saisonvergleich) anschliessend nirgends verbucht hätte.
