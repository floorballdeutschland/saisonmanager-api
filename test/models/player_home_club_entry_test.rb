...
class PlayerHomeClubEntryTest < ActiveSupport::TestCase
  ...
  # `c['valid_until'] > Time.now` verglich String mit Time und ergab immer false.
  # Eine erst kuenftig endende Zugehoerigkeit blieb beim Wechsel offen stehen — und
  # zusammen mit dem neu angehaengten Heimatverein waren es zwei offene.
